...
def cumsum(x, axis=None, dtype=None, name=None):
    ...
    Args:
        ...
        dtype (str|np.dtype|core.VarDesc.VarType, optional): The desired data type of returned tensor. If specified, the input tensor is casted to dtype before the operation is performed. This is useful for preventing data type overflows. The default value is None. 
